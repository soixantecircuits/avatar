<template>
  <div class="overflow-hidden">
    <div class="absolute bottom-0 w-full h-5/6  flex flex-col justify-center items-center layer-text" v-if="!cameraOpen">
    <div class=" flex flex-row  justify-center items-center space-x-4">
      ...
      <svg width="150" height="150" class="lg:w-80 lg:h-80" viewBox="0 0 284 242" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div v-if="cameraOpen" class="h-5/6 layer-text">
