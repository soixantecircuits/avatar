<template>
  <div>
    <div class='absolute top-40 w-full h-screen layer-text'>
      <img :src='img' class='image w-full height-85 bg-[#0C0C0C] flex flex-col justify-center items-center layer-text' />
      </div>
